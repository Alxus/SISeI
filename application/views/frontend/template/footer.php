	...
	<div id="contacto" class="container">
		<div class="row">
			<div class="col l6 s12">
				...
				<p class="white-text">Avenida Juan de Dios Bátiz #310 Pte., Instituto Tecnológico de Culiacán, 80225 Culiacán Rosales, México; Edificio B planta baja</p>
...
<script type="text/javascript" src=<? echo base_url()."assets/js/materialize.min.js"?>></script>
<script type="text/javascript"  src=<?php echo base_url()."assets/js/particles.min.js";?>></script>
<script type="text/javascript"  src=<?php echo base_url()."assets/js/main_frontend.js";?>></script>
